...
<main class="container">
    ...
    <form action="{{ route('admin.apartments.update', $apartment)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="address-input" value="{{ old('address',$apartment->address)}}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="bathrooms" value="{{old('bathrooms',$apartment->bathrooms)}}" name="bathrooms">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="beds" value="{{old('beds',$apartment->beds)}}" name="beds">
        </div>
