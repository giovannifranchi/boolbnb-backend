            ...
            <div class="col-12 p-0 my-container" onmouseover="aggiungiClassi()" onmouseout="rimuoviClassi()">
                <div class="row m-2">
                    <div class="col-12 col-md-6 d-flex flex-column p-2 my-image-container">
                        <img src="{{ $galleries[0] }}" alt="" id="thumbnail" class="w-100 square-image" {{ count($apartment->images) > 0 ? 'flex-grow-1' : 'h-100' }}">
                        <div class="preview row">
                            @foreach ($galleries as $key => $gallery)
                            <div class="box my-box-image {{ count($galleries) > 1 ? 'col' : 'col-3' }}">
                                <img src="{{ asset($gallery) }}" alt="path" class="w-100 square-image thumbnail {{ $key === 0 ? 'selected-thumbnail' : '' }}" onclick="selectImage(this)" onmouseover="enlargeImage(this)" onmouseout="resetImageSize(this)">
                            </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 {{ $key === 1 ? 'pricing__item--featured' : '' }}">
                        ...
                        <div class="generic_content clearfix">
                            ...
                            <div class="generic_price_btn clearfix">
                                <a class="" href="{{ route('admin.braintree.token', ['plan' => $plan, 'apartment' => $apartment]) }}">Sign
                                    up</a>
                            </div>
                            <!--//BUTTON END-->
