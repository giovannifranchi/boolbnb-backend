...
<main class="py-3">
    ...
    <div class="container position-relative">
        <button class="ms-button add-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
                    ...
                    <h5 class="sponsor not-active mb-3">No active plans</h3>
                        ...
                        <div class="d-flex flex-wrap gap-3">
                            <div class="box  details">
                                <a class="ms-link" href="{{ route('admin.apartments.show', $apartment) }}"><i class="fa-solid fa-list"></i>DETAILS</a>
                            </div>
                            <div class="box edit">
                                <a class="ms-link" href="{{ route('admin.apartments.edit', $apartment) }}"><i class="fa-solid fa-pen"></i> EDIT</a>
                            </div>
                            <div class="box messages">
                                <a class="ms-link" href="{{ route('admin.messages.index', $apartment) }}"> <i class="fa-regular fa-message"></i> MESSAGES</a>
                            </div>
                            <div class="box delete">
                                <a href="#" class="ms-link" data-bs-toggle="modal" data-bs-target="#apartment-{{ $apartment->id }}"><i class="fa-solid fa-trash"></i>
                                    DELETE</a>
                            </div>
                        </div>
                </div>
        ...
        <div class="offcanvas-body">
            ...
            <form action="{{ route('admin.apartments.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="preview" id="additional-images-preview" style="display: flex; width: 100px; height: 100px; margin-top: 10px; gap: 10px;"></div>
                </div>
