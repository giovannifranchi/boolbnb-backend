                ...
                <div class="card-body">
                    ...
                    <div class="container" style="margin-top: 60px;">
                        <div class="row">
                            ...
                            <div style="text-align: center; font-size: 16px; font-weight: 500; letter-spacing: 1;"> Transaction Type <svg xmlns="http://www.w3.org/2000/svg" width="40" height="24" viewBox="0 0 256 114">
                                    <rect x="0" y="0" width="256" height="114" fill="none" stroke="none" />
